...
def save_game_data(game_state, events, action, dirname):
    ...
    filename = 'data-collect/' + dirname + '/data'+str(game_state['step'])
    print(filename)
...
def reward_update(self):
    ...
    ########## DATA COLLECTION ####################
    dirname = 'game_'+str(self.round)
    #print('save data to '+dirname)
    save_game_data(self.game_state, self.events, self.next_action, dirname)
...
def end_of_episode(self):
    ...
    print('game {} finished'.format(self.round))
    self.round += 1
