...
from agent_code.batch_update.feature_extraction import *
from agent_code.batch_update.algorithms import new_reward, q_gd_linapprox
...
def setup(self):
    ...
    # load weights
    try:
        self.weights = np.load('agent_code/batch_update/models/weights.npy')
