...
def setup(self):
	...
	try:
		...
		self.training_weights = np.load('train_weights_init1_GreedA02Y1.npy')
...
def reward_update(self):
	...
	if self.game_state['step']%20 == 0:
		...
		# update weights
		weights = q_gd_linapprox(next_state, prev_state_a, self.total_R, self.weights, self.alpha, self.gamma)      
...
def end_of_episode(self):
	...
	#np.save('train_weights_init1_GreedA02Y1.npy', self.training_weights)
