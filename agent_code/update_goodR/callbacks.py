...
from agent_code.update_goodR.feature_extraction import *
from agent_code.update_goodR.algorithms import new_reward, q_gd_linapprox
...
def setup(self):
    ...
    # load weights
    try:
        self.weights = np.load('agent_code/update_goodR/models/weights.npy')
