...
if __name__ == "__main__":
    ...
    for dir in os.listdir('C:/Users/Lily/Documents/UNI/FML/project/local_branch/data-collect'):
        if not (dir.__contains__('.pickle') or dir.__contains__('.py')):
            print(os.path.abspath(dir))
            save_to_file(os.path.abspath(dir), dir+'.pickle')
